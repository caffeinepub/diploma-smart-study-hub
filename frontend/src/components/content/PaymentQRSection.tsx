...
export default function PaymentQRSection({ 
  ...
  // If auto-payment is enabled, show different UI
      ...
      <div className="space-y-6">
        <Alert className="border-2 border-success bg-success/10">
          ...
          <AlertDescription className="text-success-foreground">
            <p className="font-semibold mb-2">Automatic Payment Enabled</p>
            <p className="text-sm">
              Your payment will be processed automatically when you click the PhonePe button above. 
              No manual QR scanning required!
            </p>
          </AlertDescription>
        </Alert>
        ...
        <Card className="bg-muted/50 border-2">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-between items-center p-3 bg-background rounded-lg">
              ...
              <span className="text-lg font-semibold text-success">Automatic</span>
            </div>
          </CardContent>
        </Card>
      </div>
